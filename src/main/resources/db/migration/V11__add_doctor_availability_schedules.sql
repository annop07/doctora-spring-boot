-- V10: เพิ่มตารางเวลาให้แพทย์ทุกคนในระบบ

-- ลบตารางเวลาเก่า (ถ้ามี)
...
-- Doctor 18: นพ. ชยพล - Pediatrics (จันทร์-ศุกร์ เช้า 8-12 + บ่าย 13-17)
INSERT INTO availabilities (doctor_id, day_of_week, start_time, end_time, is_active, created_at) VALUES
(18, 1, '08:00:00', '12:00:00', true, NOW()),
(18, 1, '13:00:00', '17:00:00', true, NOW()),
(18, 2, '08:00:00', '12:00:00', true, NOW()),
(18, 2, '13:00:00', '17:00:00', true, NOW()),
(18, 3, '08:00:00', '12:00:00', true, NOW()),
(18, 3, '13:00:00', '17:00:00', true, NOW()),
(18, 4, '08:00:00', '12:00:00', true, NOW()),
(18, 4, '13:00:00', '17:00:00', true, NOW()),
(18, 5, '08:00:00', '12:00:00', true, NOW()),
(18, 5, '13:00:00', '17:00:00', true, NOW());
...
-- Doctor 20: นพ. ปริญญา - Cardiology (จันทร์ พุธ ศุกร์ 9:00-17:00)
INSERT INTO availabilities (doctor_id, day_of_week, start_time, end_time, is_active, created_at) VALUES
...
-- Doctor 22: นพ. สุรเดช - Internal Medicine เวรบ่าย (จันทร์-ศุกร์ 13:00-21:00)
INSERT INTO availabilities (doctor_id, day_of_week, start_time, end_time, is_active, created_at) VALUES
...
-- Doctor 23: นพ. อภิสิทธิ์ - Pediatrics (อังคาร-เสาร์ 9:00-17:00)
INSERT INTO availabilities (doctor_id, day_of_week, start_time, end_time, is_active, created_at) VALUES
